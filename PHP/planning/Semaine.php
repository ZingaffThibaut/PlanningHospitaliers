    ...
    if(empty($err[2])){
      if($result->rowCount()>0){
        ...
        while($row=$result->fetch()){
          $res.="<tr><td rowspan='3' id='".$row['Id_personne']."' onclick='Selectperso(".$row['Id_personne']."£".$row['Id_jour'].")' style='text-align: center;vertical-align: middle;'><b>".substr($row['Prenom'],0,1).".".$row['Nom']."</b></td>";
