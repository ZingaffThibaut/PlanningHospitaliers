function Modif(){
  $.post(
    "https://infodb.iutmetz.univ-lorraine.fr/~nunge1u/LP/PlanningHospitaliers/PHP/affimodifprofil.php",
    function(data){
      $("#modif").html(data);
...
function modif_profil(){
  ...
  $.post(
    "https://infodb.iutmetz.univ-lorraine.fr/~nunge1u/LP/PlanningHospitaliers/PHP/modifprofil.php",
    {
