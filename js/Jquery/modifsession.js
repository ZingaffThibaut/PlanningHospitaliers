function Modif(nb){
  $.post(
    "https://infodb.iutmetz.univ-lorraine.fr/~nunge1u/LP/PlanningHospitaliers/PHP/affisessionsolo.php",
    {
      Id_personne: nb
    },
    function(data){
...
function modif_session(){
  ...
  $.post(
    "https://infodb.iutmetz.univ-lorraine.fr/~nunge1u/LP/PlanningHospitaliers/PHP/modifsession.php",
    {
